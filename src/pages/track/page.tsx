            ...
            <div className="pt-[60px] px-[32px] pb-[32px] w-full h-full flex flex-col gap-5">
                ...
                <div className="flex w-full gap-1">
                    <div className="px-[24px] py-[12px] box-shadow rounded-[10px] flex gap-2 items-center border-2 border-purple-ternary bg-[#F6F3FD] relative w-[40%]">
                        <img src="/assets/logo_medicargo.svg" alt="" className="w-36 object-contain absolute -top-3 bg-gradient-to-b from-white from-45% to-[#F6F3FD] to-50% px-1"/>
                        <div className="w-full text-blue-dark">
                            <div className="flex gap-2 text-[24px] font-semibold ">
                                <h1 className="text-[28px] font-normal w-fit">
                                    Delivery ID: 
                                </h1>
                                <Dropdown 
                                    height={32} 
                    ...
                    <div className="flex grow gap-1 text-blue-dark">
                        <div className="px-[24px] py-[12px] box-shadow rounded-[10px] flex justify-between items-center border-2 border-purple-ternary bg-[#F6F3FD] relative w-1/2">
                            ...
                            <p className="text-center">
                                Current <br /> <span className="text-[28px] font-semibold">50</span>
                            </p>
                            <p className="text-center">
                                Lowest <br /> <span className="text-[28px] font-semibold">50</span>
                            </p>
                            <p className="text-center">
                                Highest <br /> <span className="text-[28px] font-semibold">50</span>
                            </p>
                        </div>
                        <div className="px-[24px] py-[12px] box-shadow rounded-[10px] flex justify-between items-center border-2 border-purple-ternary bg-[#F6F3FD] relative w-1/2">
                            ...
                            <p className="text-center">
                                Current <br /> <span className="text-[28px] font-semibold">20</span>
                            </p>
                            <p className="text-center">
                                Lowest <br /> <span className="text-[28px] font-semibold">20</span>
                            </p>
                            <p className="text-center">
                                Highest <br /> <span className="text-[28px] font-semibold">20</span>
                            </p>
                        </div>
                    </div>
                </div>
